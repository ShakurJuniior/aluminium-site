  ...
  title: formData.subject || 'New Inquiry',   // matches {{title}} in template
  message: formData.message,
  time: new Date().toLocaleString(),           // adds current time
};
    ...
    return (
      <section id="contact" className="py-24 bg-gradient-to-b from-gray-200 to-gray-100">
            ...
            <div data-aos="fade-right" className="space-y-8">
              ...
              <div className="space-y-4 pt-4">
                ...
                >
                  ...
                  <span className="font-sans">info@agnesaluminum.com.ng</span>
                </a>
                ...
                <div className="flex items-start gap-4 text-gray-700">
                  ...
                  <div>
                    ...
                    <span className="block font-sans">Km 7 Aba-Enugu Express Road, Osisioma, Aba, Abia State, Nigeria</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 text-gray-700">
                  ...
                  <div>
                    ...
                    <span className="block font-sans">Km 20 Aba/PH Expressway, Iriegbe Akashi bus stop, Obiakpor LGA, beside Earthwall filling station</span>
                  </div>
                </div>
              </div>
            </div>
