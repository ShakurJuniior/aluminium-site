        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-16 py-20 lg:py-32 flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 space-y-8">
            ...
            >
              ...
              <Link
      to="/services"
      className="px-8 py-4 text-sm font-semibold bg-blue-500 text-white rounded-xl hover:bg-blue-400 transition-all duration-300 shadow-md hover:shadow-lg hover:shadow-blue-200/50 inline-block text-center"
    >
      Explore Services
    </Link>   
              {/* Secondary – light outline */}
              <Link to = "/products" className="px-8 py-4 text-sm text-center font-semibold border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-100 hover:border-gray-400 transition-all duration-300">
                View Catalog
              </Link>
          ...
          >
            <div className="relative overflow-hidden rounded-2xl border  border-white/60 bg-white/30  shadow-md lg:mx-8 lhover:shadow-xl transition-shadow duration-300 backdrop-blur-sm">
