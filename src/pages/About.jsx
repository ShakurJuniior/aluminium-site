    ...
    return (
        ...
        <section className="relative py-24 lg:py-32 overflow-hidden">
            ...
            <div className="max-w-3xl">
                ...
                >
                Crafting the future <br />with precision aluminium.
                </h1>
                <p
                data-aos="fade-up"
                data-aos-delay="100"
        ...
        <section className="py-16 bg-white/50 backdrop-blur-sm border-y border-gray-200">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                >
                    <div className="font-heading text-3xl md:text-4xl font-bold text-blue-600">
                    {stat.value}
                    </div>
        ...
        <section className="py-24">
            ...
            <p
                data-aos="fade-up"
                data-aos-delay="50"
                className="font-sans text-gray-600 text-center max-w-2xl mx-auto mb-16"
            >
        ...
        <section className="py-20 bg-gradient-to-b from-white to-gray-50">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div data-aos="fade-left" className="rounded-2xl overflow-hidden shadow-xl border border-gray-200 h-80 lg:h-96">
                <iframe
